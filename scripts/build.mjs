...
<nav id="main-nav">
  ...
  <div class="nav-r">
    ...
    ${link('https://news.enterpriseonchain.com/', 'Content Library <span class="arrow">↗</span>', null, true)}
...
<aside class="nav-drawer" id="nav-drawer" aria-label="Mobile menu">
  ...
  ${drawerLink('https://news.enterpriseonchain.com/', 'Content Library ↗', null, true)}
...
<main class="page">
  <article class="inner reveal edition">
    ...
    <div class="edition-cta">
      <a href="https://news.enterpriseonchain.com/" target="_blank" rel="noopener" class="btn btn-ghost">Read on Beehiiv ↗</a>
